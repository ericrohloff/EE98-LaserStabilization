...
proc create_ipi_design { offsetfile design_name } {
	...
	set axi_registers_0 [ create_bd_cell -type ip -vlnv user.org:user:axi_registers:1.0 axi_registers_0 ]
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores user.org:user:axi_registers:1.0]]]]
